...
const checkOverlap = (assignmentPair: AssignmentPair): boolean => {
  if(assignmentPair.assignment1[1] >= assignmentPair.assignment2[0] && assignmentPair.assignment1[0] <= assignmentPair.assignment2[1]){
    return true;
  }
  if(assignmentPair.assignment2[1] >= assignmentPair.assignment1[0] && assignmentPair.assignment2[0] <= assignmentPair.assignment1[1]){
    return true;
  }
  return false;
}
